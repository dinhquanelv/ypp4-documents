IF DB_ID('MSListsV15') IS NULL
BEGIN
    CREATE DATABASE MSListsV15;
END;
GO
...
IF OBJECT_ID('ShareLinkOptionValue', 'U') IS NOT NULL DROP TABLE ShareLinkOptionValue;
IF OBJECT_ID('ShareLinkOption', 'U') IS NOT NULL DROP TABLE ShareLinkOption;
...
IF OBJECT_ID('AccountWorkspace', 'U') IS NOT NULL DROP TABLE AccountWorkspace;
...
CREATE TABLE ViewType (
    ...
    HeaderImage NVARCHAR(100) NOT NULL,
...
CREATE TABLE List (
    ...
    AccessedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    CreatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    UpdatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME()
);
...
CREATE TABLE FavoriteList (
    ...
    FavoredBy INT NOT NULL FOREIGN KEY REFERENCES Account(Id),
    CreatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    UpdatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME()
);
...
CREATE TABLE SystemColumnSettingValue (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    SystemColumnId INT NOT NULL FOREIGN KEY REFERENCES SystemColumn(Id),
...
CREATE TABLE ShareLinkOptionValue (
    ...
    ShareLinkOptionId INT NOT NULL FOREIGN KEY REFERENCES ShareLinkOption(Id),
...
CREATE TABLE FileAttachment (
    ...
    DeleteAt DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    UpdatedAt DATETIME2 NOT NULL DEFAULT SYSDATETIME()
);
